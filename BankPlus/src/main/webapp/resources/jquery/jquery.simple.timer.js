...
//			var minutes = document.createElement('div');
			...
			// append(hours).
			append(minutes).append(seconds).append(clearDiv);
		};
		...
		this.targetElement.each(function(_index, timerBox) {
			...
			timerBoxElement.on('complete', function() {
				if (options && options.loop === true) {
					timer
							.resetTimer(timerBoxElement, options,
									cssClassSnapshot);
				}
			});
	 ...
	 * $timerBox {jQuery object} - The timer element options {object} - The
	 * options for the timer css - The original css of the element
	 */
